...
model = dict(
    ...
    head=dict(
        ...
        loss_oks=dict(type="OKSLoss", reduction="none", metainfo="configs/_base_/datasets/coco.py", norm_target_weight=True, loss_weight=30.0),
...
train_pipeline_stage1 = [
    ...
    dict(type="YOLOXMixUp", img_scale=(640, 640), ratio_range=(0.8, 1.6), pad_val=114.0, pre_transform=[dict(type="LoadImage", backend_args=None)]),
...
train_dataloader = dict(
    batch_size=32, num_workers=8, persistent_workers=True, pin_memory=True, sampler=dict(type="DefaultSampler", shuffle=True), dataset=dataset_coco
)
